...
- [Financial Advisor (HITL)](./examples/hitl-financial-advisor.md)
- [Web Service](./examples/web-service.md)

---

# API Reference

- [agents-sdk](./api/agents-sdk.md)
- [ConfigurableAgentBuilder](./api/builder.md)
- [Tool Macro](./api/tool-macro.md)
